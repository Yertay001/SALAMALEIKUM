    ...
    operations = [
        ...
        migrations.CreateModel(
            ...
            fields=[
                ...
                ('customer', models.OneToOneField(on_delete=apps.accounts.models.Customer, to=settings.AUTH_USER_MODEL)),
            ],
        ),
        migrations.CreateModel(
            name='Adresses',
            fields=[
                ...
                ('profile', models.ForeignKey(on_delete=apps.accounts.models.Profile, to='accounts.profile')),
            ],
        ),
    ]
